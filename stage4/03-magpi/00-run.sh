...
install -v -o 1000 -g 1000 -d "${ROOTFS_DIR***REMOVED***/home/${FIRST_USER_NAME***REMOVED***/MagPi"
install -v -o 1000 -g 1000 -m 644 "files/$magpi_latest" "${ROOTFS_DIR***REMOVED***/home/${FIRST_USER_NAME***REMOVED***/MagPi/"
